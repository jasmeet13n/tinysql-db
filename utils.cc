...
class Utils {
public:
  static void getColumnNamesRecursively(std::vector<std::string>& result, ParseTreeNode* node) {
  ...
  static void getDataTypesRecursively(std::vector<enum FIELD_TYPE>& result, ParseTreeNode* node) {
  ...
  static std::vector<std::string> getColumnNames(ParseTreeNode* root) {
    std::vector<std::string> result;
    if(root->type == NODE_TYPE::CREATE_TABLE_STATEMENT) {
      // children[4] -> attribute_type_list
      getColumnNamesRecursively(result, root->children[3]);
    }
    return result;
  }

  static std::vector<enum FIELD_TYPE> getDataTypes(ParseTreeNode* root) {
    std::vector<enum FIELD_TYPE> result;
    if(root->type == NODE_TYPE::CREATE_TABLE_STATEMENT) {
      // children[4] -> attribute_type_list
      getDataTypesRecursively(result, root->children[3]);
    }
    return result;
  }

  static std::string getRelationName(ParseTreeNode* root) {
